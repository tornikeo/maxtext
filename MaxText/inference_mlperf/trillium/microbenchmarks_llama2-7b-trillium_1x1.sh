# Run command:
# bash microbenchmarks_llama2-7b-trillium_1x1.sh
# Look at profiles:
# tensorboard --logdir /tmp/mb/profiles/trillium_llama2_7b/tensorboard/prefill_insert_1024


run_name="trillium_llama2-7b"
dry_run=false
...
export LOAD_PARAMETERS_PATH=gs://wyzhang-dev/maxtext/llama2-7b-chat/ckpt-int8w
